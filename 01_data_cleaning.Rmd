...
GUW <- GUW %>% 
  ...
  separate(., col = filename, into = c("site_code", "date", "time"), sep = "_") %>% #splitting filename into three columns: site_code, date, and time
...
write.csv (GUW, 'C:/Users/pavit/OneDrive/Desktop/IISER-Tirupati-FA-2025_App/COVIDSoundscapes-project/BirdNET/results/GUW_BirdNET_annotations.csv')
...
DEL <- DEL %>% 
  ...
  dplyr::select (selection, view, channel, begin_time, end_time, low_freq, high_freq, common_name, species_code, confidence, filename, file_offset) %>%
  separate(., col = filename, into = c("site_code", "date", "time"), sep = "_") %>% 
 mutate(time = tools::file_path_sans_ext(time)) %>%
  na.omit () %>% 
 filter (!common_name == 'nocall')

write.csv (DEL, 'C:/Users/pavit/OneDrive/Desktop/IISER-Tirupati-FA-2025_App/COVIDSoundscapes-project/BirdNET/results/DEL_BirdNET_annotations.csv')
...
write.csv (KOD, 'C:/Users/pavit/OneDrive/Desktop/IISER-Tirupati-FA-2025_App/COVIDSoundscapes-project/BirdNET/results/KOD_BirdNET_annotations.csv')
...
write.csv (MUM, 'C:/Users/pavit/OneDrive/Desktop/IISER-Tirupati-FA-2025_App/COVIDSoundscapes-project/BirdNET/results/MUM_BirdNET_annotations.csv')
...
write.csv (TPT, 'C:/Users/pavit/OneDrive/Desktop/IISER-Tirupati-FA-2025_App/COVIDSoundscapes-project/BirdNET/results/TPT_BirdNET_annotations.csv')
...
write.csv (VAL, 'C:/Users/pavit/OneDrive/Desktop/IISER-Tirupati-FA-2025_App/COVIDSoundscapes-project/BirdNET/results/VAL_BirdNET_annotations.csv')
```
